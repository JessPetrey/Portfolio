        ...
        <div className=''>
            <div className='flex flex-col bg-neutral py-10'>
                ...
                <div className='place-self-center'>
                    <iframe height="990" width="800" src="https://docs.google.com/document/d/e/2PACX-1vRHAWTtMkNMT09sxgqufIkxj2U_XgDX167288WQPKPbZyJxJYO4kvVS1boqGtVlTMN3xGcRrb3K2fQv/pub?embedded=true"></iframe>
                </div>
            </div>
        </div>
    )
